...
from speaker_encoder import SpeechEmbedder
...
criterion_embeddings = torch.nn.CosineSimilarity()
...
def train_local(i, epoch, batch, id_1, id_2, losses):
        ...
        real_embedding_x1 = speech_embedder(X1)
        real_embedding_x2 = speech_embedder(X2)

        recon_embedding_x1 = speech_embedder(recon_X1)
        recon_embedding_x2 = speech_embedder(recon_X2)

        embedding_loss_x1 = lambda_6 * criterion_embeddings(real_embedding_x1,recon_embedding_x1)
        embedding_loss_x2 = lambda_6 * criterion_embeddings(real_embedding_x2,recon_embedding_x2)
        ...
        # Losses
        loss_GAN_1_X = lambda_0 * criterion_GAN(D[id_1](fake_X1), valid)
        loss_GAN_1 = loss_GAN_1_X
        
        loss_GAN_2_X = lambda_0 * criterion_GAN(D[id_2](fake_X2), valid)

        loss_GAN_2 = loss_GAN_2_X
